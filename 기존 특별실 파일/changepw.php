...
<?php
  ...
  if(CookieLogin($connect))
  {
    ...
    {
      $id = $_COOKIE['ID'];
      $pw = $connect->query("select PW from db where ID = '".$id."';")->fetch_array()['PW'];
      $lastpw = $_POST['lastpw'];
      $newpw = $_POST['newpw'];
      ...
      if(strcmp($pw, $lastpw))
      {
        ...
        $connect->query("update db set PW='".$newpw."' where ID='".$id."';");
        echo "
        <script>
...
<body>
  ...
  <div class="container body-content">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-xs-12 login-card">
