...
<?php
  ...
  if(IsCookieSet() && CookieLogin($connect))
  {
      ...
      $purpose = $row['Purpose'];
      //목적 표시
      $time = array((int)($row['StartTime']), (int)($row['EndTime']));
      $time = $time[0].'차 면학 ~ '.$time[1].'차 면학';
      // 시간 표시
...
<body class="htmlNoPages">
  ...
  <div class="col-lg-3 col-md-2"></div>
    <div class="col-lg-6 col-md-8 card" style="font-size:1.2em;">
      추가 신청을 원한다면? 👉 <a style="font-size:1.2em;" href="student.php">추가 신청 페이지로 가기</a><br><br>
      현재 학교에서는 면학 2교시의 특별실 신청을 특별한 상황이 없으면 금지하고 있습니다.
      본 기능은 만약의 상황(다른 사람의 특별실을 대신 신청해줄 때)을 위해 만들어졌으며,
      만약 허락을 받은 후 2교시 신청을 하더라도 1교시와 2교시 구분을 명확히 해주세요.
      <br><br>
      현재는 특별실을 두 교시 각각 신청했을 때 하나의 신청 사항만 보입니다. 취소할 경우에도 둘 다 한 번에 취소됩니다. 이는 곧 업데이트하겠습니다.
     </div>
  </div> -->
  ...
  <div class="container body-content">
    ...
    <div class="col-lg-6 col-md-8 card">
            <h3><b>실시간 신청 상황 알림 페이지</b><h3>
              <h5>*지속적인 새로고침이 필요합니다. 자신의 팀이 승인되었는지 꼭 확인하기 바랍니다. 복수 신청된 경우에는 관리자가 하나만 남기고 다 삭제합니다. 선생님이 신청한 항목은 목적에 다르게 나타납니다.</h5>
              <h6>
              <?php
