...
<body>
  ...
  <div class="container-fluid body-content">
    ...
    <div class="alert alert-info" role="alert" style="margin-top: 40px">
      <span style="font-size: 24px; font-weight: bold;">PatchNote 7.02</span>
      <div style="font-size: 18px; margin-left: 14px; margin-top: 6px;">
        <div style="font-size: 24px; margin-left: -10px; margin-bottom:-14px;"><em>추가할 사항이 아직도 많아요!</em></div><br>
        <div style="height: 7px;"></div>
        <strong>선생님 페이지를 주로 업데이트하였습니다. </strong><br>
        <strong>학생용 업데이트 상황 / Q&A 상황은 다음을 참고해주세요. </strong><br>
        <a href="슬기로운제곽생활_안내_200702.pdf" target="_blank" style="margin-right: 10px;">업데이트 확인하기</a>
      </div>
    </div>
    <div class="alert alert-info" role="alert" style="margin-top: 40px">
