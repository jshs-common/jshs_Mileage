  ...
  <div class="container body-content">
    ...
    <div class="row">
        ...
        <br>
            ...
            $count = 0;
            $result = $connect->query("select * from apply where TeacherSID='".$SID."' and IsApproved = 0;");
        ...
        <div class="col-sm-5">
            <div class="row">
                <div class="col-sm-12" style="background-color:white; box-shadow: 0 8px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 30px; padding-bottom: 5%; float: center; margin-left:5%; margin-bottom:5%;">
                <br>
                ...
                $item .= '<div class="panel-heading">'.$title.'</div><details><summary>세부사항 보기</summary><p>';
                $item .= '<div class="panel-body"><ul>';
                    $item .= '<li>신청 학생 : '.substr($students, 0, -2).'</li>';
                    $item .= '<li>신청 시간 : '.$time[0].'차 면학 ~ '.$time[1].'차 면학'.'</li>';
                    $item .= '<li>신청 장소 : '.$row['Location'].'</li>';
                $item .= '</ul></div></p></details>';
