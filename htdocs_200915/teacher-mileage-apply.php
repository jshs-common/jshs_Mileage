<?php
    ...
    if($description1 == ""){
        $description = $_POST['description2']." (사유 :".$_POST['descript1'].")";
    }
    else{
    ...
    for($i = 0 ; $i < $cnt ; $i++){
        ...
        $insert = mysqli_query($connect, "INSERT INTO mileagehistory (SID, Checkdate, period, Isminus, type, description, plus, minus, teachername) VALUES (".$row[0].", '".$date."', 2, 0, '".$type."', '".$description."', ".$pointsum.", 0, '".$usernamesplited[0]."')") or die(mysqli_error($connect));
        $insert = mysqli_query($connect, "INSERT INTO mileagehistory_real (SID, Checkdate, period, Isminus, type, description, plus, minus, teachername) VALUES (".$row[0].", '".$date."', 2, 0, '".$type."', '".$description."', ".$pointsum.", 0, '".$usernamesplited[0]."')") or die(mysqli_error($connect));
