...
for($i = 0 ; $i < $cnt ; $i++){
    ...
    $insert = mysqli_query($connect, "INSERT INTO mileagehistory_real (SID, Checkdate, period, Isminus, type, description, plus, minus, teachername) VALUES (".$row[0].", '".$date."', 1, 0, '기타', '".$noticerow['title']."', ".$noticerow['score'].", 0, '".$usernamesplited[0]."')") or die(mysqli_error($connect));
