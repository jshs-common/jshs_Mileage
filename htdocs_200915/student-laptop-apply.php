        ...
        <ol class="form-ol">
          ...
          <li>
            ...
            <div class="li-inside">
              <?php
                $weekday = date('w');
                $lend  = 6 - $weekday;//빌리려고 하는 날짜
                $day = date("d") + $lend;//현재 날짜에 선택한 기간을 더하여 정함
                if ($day < 10) {
                  $day = "0".$day;
                }
                echo '<label style="font-size: 400;">'.date("20y년 m월 d일"),"~"."</label>";
                echo '<label style="font-size: 400;">'."$day","일까지 대여합니다."."</label><br>";
                echo '<label style="color: crimson;font-size: 100;">집에 가기 전에 반납해주세요!</label>';
              ?>
            <!--   <div>
                <label>대여 기간 : </label>
                <div class="btn-group">
                ...
                <input type="hidden" name="lenddate" id="ld-input" value='<?php echo $day;?>'>
                <!-- <label>일</label>
              </div>
            </div> -->
          </li>
