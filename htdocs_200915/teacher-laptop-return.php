...
//<th class='remark-column'; style='text-align:center;'>내용물 분실 여부</th>
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    if($row[2] == 1){
                                        echo "<td style='text-align:center; color:red;'>수리중</td>";
                                        ...
                                        <form action='teacher-laptop-finish.php' method='post'>
                                            ...
                                            <input type='hidden' name='cannotborrow' value='2'>
                                            <button type='submit' class='btn btn-warning' style='font-size:14px; margin:0px; border:0px; padding:3px 15px;'>수리완료</button>
                                            </form>
                                        </td>";
                                    }
                                    else{
                                        echo "<td style='text-align:center; color:green;'>
                                            ...
                                            <input type='hidden' name='SubjNum' value='".$row[4]."'>
                                            <input type='hidden' name='borrow' value='".$row[3]."'>
                                            <input type='hidden' name='cannotborrow' value='-1'>
                                            <button type='submit' class='btn btn-danger ' style='font-size:14px; margin:0px; border:0px; padding:3px 15px;'>고장</button>
                                            </form>
                                        </td>";
                                        if($row[3] == 2){
                                            echo "<td style='text-align:center; color:green;'>
                                            ...
                                            <input type='hidden' name='SubjNum' value='".$row[4]."'>
                                            <input type='hidden' name='borrow' value='".$row[3]."'>
                                            <input type='hidden' name='cannotborrow' value='0'>
                                        ...
                                        elseif ($row[3] == 1) {
                                            ...
                                            <input type='hidden' name='borrow' value='".$row[3]."'>
                                            <input type='hidden' name='cannotborrow' value='1'>
                                            <button type='submit' class='btn btn-info' style='font-size:14px; margin:0px; border:0px; padding:3px 15px;'>대여</button>
                                            </form>
                                            </td>";
                                        }
                                    }
