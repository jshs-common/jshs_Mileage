    ...
    <body>
        ...
        <script>
            function categoryChange2() {
                ...
                if($("#minusstep3").val() == "모범") var d = good; $('#selboxDirect2').val("");
            ...
            function categoryChange() {
                ...
                if($("#minusstep1").val() == "일과 전반") var d = daytime; $('#description').val("");
                if($("#minusstep1").val() == "조조") var d = morning; $('#description').val("");
                if($("#minusstep1").val() == "면학실") var d = studyroom; $('#description').val("");
                if($("#minusstep1").val() == "생활관") var d = domit; $('#description').val("");
