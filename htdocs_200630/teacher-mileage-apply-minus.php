<?php
    ...
    if($description1 == ""){
        $description = $_POST['descriptionmi'];
    }
    else{
    ...
    for($i = 0 ; $i < $cnt ; $i++){
        ...
        $insert = mysqli_query($connect, "INSERT INTO mileagehistory (SID, Checkdate, period, Isminus, type, description, plus, minus, teachername) VALUES (".$row[0].", '".$date."', 1, 1, '".$type."', '".$description."', 0, ".$point.", '".$usernamesplited[0]."')") or die(mysqli_error($connect));
