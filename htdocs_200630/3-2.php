                    ...
                    <div id="result">
                        <h6>
                            <?php
                                ...
                                if($period == "all"){
                                    if($isminus == "all"){
                                        $searchsql3 = mysqli_query($connect, "SELECT * FROM mileagehistory WHERE SID = ".$SID."  AND  (description LIKE '%".$search."%' OR teachername LIKE '%".$search."%')") or die(mysqli_error($connect));
                                    }
                                    else{
                                        $searchsql3 = mysqli_query($connect, "SELECT * FROM mileagehistory WHERE SID = ".$SID." AND Isminus = ".$isminus ." AND (description LIKE '%".$search."%' OR teachername LIKE '%".$search."%')") or die(mysqli_error($connect));
                                    }
                                }
                                if($period != "all"){
                                    if($isminus == "all" ){
                                        $searchsql3 = mysqli_query($connect, "SELECT * FROM mileagehistory WHERE SID = '".$SID."' AND period = ".$period ." AND (description LIKE '%".$search."%' OR teachername LIKE '%".$search."%')") or die(mysqli_error($connect));
                                    }
                                    else{
                                        $searchsql3 = mysqli_query($connect, "SELECT * FROM mileagehistory WHERE SID = ".$SID." AND period = ".$period." AND Isminus = ".$isminus." AND (description LIKE '%".$search."%' OR teachername LIKE '%".$search."%')") or die(mysqli_error($connect));
                                    }
                                }
