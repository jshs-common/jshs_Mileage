        ...
        <ol class="form-ol">
            ...
            <div class="li-inside">
              ...
              <div>
                <div class="btn-group">
                  ...
                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ><!--드롭다운 버튼 설정 (글자와 버튼 구분)-->
                      <span class="caret" style="margin-right: -6; margin-left: -2;"></span><!--삼각형-->
                      <label></label>
                  </button>
          ...
          <li>
            ...
            <div class="li-inside">
              <div>
                <div class="btn-group">
                  <button type="button" class="btn btn-default" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="grade-button">1</button>
                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                      <span class="caret" style="margin-right: -6; margin-left: -2;"></span>
                      <label></label>
                  </button>
                  <ul class="dropdown-menu">
                    <li><a href="javascript:;" onclick="set_inf(0, 1);">1</a></li>
                    <li><a href="javascript:;" onclick="set_inf(0, 2);">2</a></li>
                    <li><a href="javascript:;" onclick="set_inf(0, 3);">3</a></li>
                  </ul>
                </div>
                <input type="hidden" name="grade" id="grade-input" value=“1”>
                <span>학년 </span>

                <div class="btn-group">
                  <button type="button" class="btn btn-default" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="class-button">1</button>
                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                      <span class="caret" style="margin-right: -6; margin-left: -2;"></span>
                      <label></label>
                  </button>
                  <ul class="dropdown-menu">
                    <li><a href="javascript:;" onclick="set_inf(1, 1);">1</a></li>
                    <li><a href="javascript:;" onclick="set_inf(1, 2);">2</a></li>
                  </ul>
                </div>
                <input type="hidden" name="class" id="class-input" value="1">
                <span>반 </span>
...
<script>
  ...
  function set_inf(target, value) {
    var buttons = ["grade-button", "class-button"];
    var inputs = ["grade-input", "class-input"];
